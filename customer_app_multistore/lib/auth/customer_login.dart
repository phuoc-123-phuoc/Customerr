...
import 'package:customer_app_multistore/minor_screens/forgot_password.dart';
import 'package:customer_app_multistore/providers/auht_repo.dart';
import 'package:customer_app_multistore/widgets/auth_widgets.dart';
...
class _CustomerLoginState extends State<CustomerLogin> {
  ...
  void logIn() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      MyMessageHandler.showSnackBar(
          _scaffoldKey, 'Vui lòng điền đầy đủ thông tin');
    }
  }
