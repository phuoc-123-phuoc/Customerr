                ...
                child: Column(
                    ...
                    children: [
                      ...
                      widget.order['deliverystatus'] == 'shipping'
                          ? Text(
                              'Estimated Delivery Date: ${widget.order['deliverydate'] != null ? DateFormat('yyyy-MM-dd').format(DateTime.tryParse(widget.order['deliverydate']) ?? DateTime.now()) : 'Invalid Date'}',
                              style: const TextStyle(
